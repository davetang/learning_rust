...
In this section, we'll add the searching logic using the test-driven
...
TDD can help drive code design; writing the test before you write the code that
makes the test pass helps to maintain high test coverage throughout the
process.
